export default function Footer() {
    const contractUrl = `https://mumbai.polygonscan.com/address/${String(process.env.REACT_APP_CONTRACT_ADDRESS)}`
    return (
        <footer>
            <div className="App-footer">
                ...
                <div className="texts">
                    ...
                    <div className="address">
                        <p>Smart Contract Address:  <a href={contractUrl} target='_blank' rel="noreferrer">{String(process.env.REACT_APP_CONTRACT_ADDRESS)}</a></p>
